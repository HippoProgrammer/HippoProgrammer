...
* TV aerial revisited (v3) - ~~Trying to stop the 3D printed case of the Pi 4 from melting~~ - fixed with a new PETG case, but trying to make TVHeadend actually stay up is more difficult than anticipated
...
* Building a library system (in collaboration with @SuitablyMysterious - The-CS-Nerds/Library-System) - _our entire backend and frontend didn't play nice_
* Re-building the aforementioned library system (The-CS-Nerds/Library-System-v2) - _the rewrite effort failed_
* Re-re-building said library system (The-CS-Nerds/Library-System-v3) - _better plan, worse execution_
* Building a timetable generation program (in collaboration with @SuitablyMysterious and @goldenfootieSchool) - _never got anywhere_
...
* Python app that interfaces with the TFL API to fetch a station list and generate the shortest journey on all Underground lines (written in collaboration with ChatGPT) - _it broke, and would have been very difficult to make work with just the TfL API, as I was trying_
